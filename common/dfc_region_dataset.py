...
classnames = np.array(["forest", "shrubland", "savanna", "grassland", "wetland", "cropland", "urban/built-up", "barren", "water"])
...
class DFCRegionDataset(Dataset):
    def __init__(self, dfcpath, region, transform, verbose=False):
        super(DFCRegionDataset, self).__init__()
